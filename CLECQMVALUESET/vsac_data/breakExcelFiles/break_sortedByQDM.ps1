...
$sourceFilePath =  "\\Mac\Home\Documents\Reporting\auxiliaries\2021\CLECQMVALUESET\vsac_data\sortedByQDM\"

$sourceFileName = "ep_ec_only_category_20200507.xlsx"
...
for ($i = 1; $i -le $workSheetCount; $i++) {
  ...
  $filename = $scratchRoot + "temp\" + "intermediary_ecqi-sortedByQDM-" + $worksheet.Name
